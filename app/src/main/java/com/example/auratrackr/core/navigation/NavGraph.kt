...
import com.example.auratrackr.features.onboarding.ui.AnimatedSplashScreen
...
private fun NavGraphBuilder.authGraph(navController: NavHostController) {
    navigation(
        ...
        authStartEntries(navController)
        authRemainingEntries(navController)
    }
}

private fun NavGraphBuilder.authStartEntries(navController: NavHostController) {
...
private fun NavGraphBuilder.authRemainingEntries(navController: NavHostController) {
    ...
    composable(Screen.FitnessOnboarding.route) {
        FitnessOnboardingScreen(onLetsStartClicked = {
...
private fun NavGraphBuilder.mainAppGraph(navController: NavHostController) {
    navigation(
        ...
        mainPrimaryEntries(navController)
        mainSecondaryEntries(navController)
    }
}

private fun NavGraphBuilder.mainPrimaryEntries(navController: NavHostController) {
    ...
    composable(
        ...
        arguments = listOf(
            navArgument(Screen.ScheduleEditor.ARG_SCHEDULE_ID) { type = NavType.StringType; nullable = true }
        )
    ) {
    ...
    // extracted to keep this function short for static analysis
    mainPrimaryWorkoutEntries(navController)
...
private fun NavGraphBuilder.mainSecondaryEntries(navController: NavHostController) {
...
// Extracted helpers to keep mainPrimaryEntries concise for static analysis
private fun NavGraphBuilder.mainPrimaryVibeEntry(navController: NavHostController) {
...
private fun NavGraphBuilder.mainPrimaryWorkoutEntries(navController: NavHostController) {
    composable(
